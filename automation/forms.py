...
# New Form: ParameterConfigForm (matches ParameterConfig data structure)
class ParameterConfigForm(forms.Form):
    ...
    value_manipulation = forms.ChoiceField(
        choices=VALUE_MANIPULATION_CHOICES, label="Value Manipulation", required=False
    )
